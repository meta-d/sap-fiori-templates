...
import { computed, DestroyRef, inject, Inject } from '@angular/core';
...
/*路由复用*/
// 参考 https://zhuanlan.zhihu.com/p/29823560
...
export class SimpleReuseStrategy implements RouteReuseStrategy {
  ...
  // 是否有多页签，没有多页签则不做路由缓存
  isShowTab = computed(() => this.#appStore.personalization().isShowTab)
  ...
  shouldDetach(route: ActivatedRouteSnapshot): boolean {
    ...
    const isShowTab = this.isShowTab();
